...
export default function Section5() {
    ...
    const checkIfCentered = () => {
        if (targetRef.current) {
            ...
            if (Math.abs(viewportCenter - elementCenter) < rect.height / 2 || isInView) {
                // setIsCentered(true);
                var i = 0;
                if (isInCenter === false) {
                    for (let i = 0; i <= 10; i++) {
                ...
                >
                    <div className='w-[308px] mt-4 '>
                        ...
                        <div ref={targetRef} className='w-[300px] h-[82px] text-center'>
                            <span className='text-[#F00832] font-ppeditorialnew leading-[41.4px] text-4xl italic font-extrabold text-center'>Here’s how it works</span>
                        </div>
                        {/* DIVIDER LINE */}
                        ...
                        <div className='flex flex-col justify w-[310px] h-[410px] mt-6 flex-grow scoll-smooth no-scrollbar overflow-scroll'>
                            <div ref={scrollableDivRef} className='h-[410px] overflow-auto overflow-x-hidden no-scrollbar scroll-smooth flex-grow'>
                                <div className='flex justify-end'>
                                    ...
                                    >
                                        ...
                                        <div className='w-[21px] h-[21px] bg-white rounded-full border-dashed border-[1px] border-black'>
                                            <Image className='w-[20.7px] h-[20.7px] px-[4px] py-[4px]' src={catSvg} unoptimized alt='open' />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='flex justify-start'>
                                    ...
                                    >
                                        <div className='w-[21px] h-[21px] bg-white rounded-full border-dashed border-[1px] border-black'>
                                            <Image className='w-[20.7px] h-[20.7px] px-[4px] -mt-[1px]' src={logoMobileImg} alt='open' />
                                        </div>
                                ...
                                <div className='flex justify-end mt-2'>
                                    ...
                                    >
                                        ...
                                        <div className='w-[21px] h-[21px] bg-white rounded-full border-dashed border-[1px] border-black'>
                                            <Image className='w-[20.7px] h-[20.7px] px-[4px] py-[4px]' src={catSvg} alt='open' unoptimized />
                                        </div>
                                    </div>
                                </div>
                                <div className='flex justify-start'>
                                    ...
                                    >
                                        ...
                                        <div className='w-[133.41px] font-normal'>
                                            ...
                                            <ol className='px-[10px] ml-[6px] list-decimal max-w-[133.41px]'>
                                                <li>Sign up using &apos;Join the waitlist button&apos;</li>
                                                <li>Verify that you have spent ≥₹10K</li>
                                                <li>Rate the products that you&apos;ve bought. We use this to understand your skin type and preferences better</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
