...
const Navbar = () =>
    // { isMessageBoxOpen, setIsMessageBoxOpen }: Props
    {
                    ...
                    <>
                        <nav
                            ...
                            style={{
                                ...
                                borderImageSource: "radial-gradient(80.38% 222.5% at -13.75% -12.36%, #98F9FF 0%, rgba(255, 255, 255, 0) 100%)",
                        ...
                        >
                            <div className='px-12 md:px-9'>
                                <div className='flex items-center justify-between h-[60px] md:h-[63px]'>
                                    ...
                                    <Link href='#howitworks' className='text-sm hidden font-semibold md:flex'>
                                        HOW IT WORKS
                                    </Link>
                                    <Separator orientation='vertical' className='bg-[#00A8FE80] h-[23px] hidden md:block' />
                                    <div onClick={handleMobileMessageBox} className='md:hidden block relative cursor-pointer'>
                                    ...
                                    <div onClick={handleMessageBox} className='md:block hidden relative cursor-pointer'>
                                        <Image src={chatIcon} alt='chat' />
                                        {!viewed && (
                                            <Badge className='absolute -top-1 -right-1 p-0 pt-[1px] bg-red-600 text-white rounded-full w-[14px] h-[14px] flex justify-center items-center text-[8px] hover:bg-red-600'>
                                                1
