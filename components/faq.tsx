...
export default function Faq() {
    ...
    const mailToLinkV = `mailto:v@honestly.club?subject=${encodeURIComponent("I want to work at Honestly")}`;

    const mailToLinkK = `mailto:k@honestly.club?subject=${encodeURIComponent("Quick Question")}`;
                ...
                <div className='flex flex-row'>
                    <div className='h-[302px] w-full border-black border-[0.5px]'>
                        <Link
                            ...
                            className={`${clickedMobileOne ? "bg-white" : ""} flex flex-row w-full`}
                        >
                            <div className='w-full h-[73px] border-black border-[0.5px]'>
                                <div className=' font-semibold text-[13px] leading-[26px] flex items-center px-6 h-full'>Tell me more, I like to read long form</div>
                            </div>
                        </Link>
                        <div className='flex flex-row w-full'>
                            <div
                                onClick={handleMobileFaqTwo}
                                className={`${clickedMobileTwo ? "bg-white" : ""}  flex flex-col gap-2  w-1/2 h-[83px] border-black border-[0.5px] cursor-pointer`}
                            >
                            ...
                            <div className={`flex flex-col gap-2 w-1/2 h-[83px] cursor-pointer border-black border-[0.5px] ${clickedMobileThree ? "bg-white" : ""}`}>
                                <div onClick={handleMobileFaqThree} className={` font-semibold text-[13px]  leading-[26px] px-6 py-[14px] `}>
                        ...
                        <div className='flex flex-row'>
                            ...
                            >
                                <div className='flex items-center gap-2'>
                                    <div className=' font-semibold text-[13px] leading-[26px] px-6 py-[24px]'>Instagram</div>
                            ...
                            <div className='w-full h-[73px]'>
                                <Link
                                    ...
                                    className={`${clickedMobileFive ? "bg-white" : ""} h-[73px] border-black border-[0.5px] flex items-center gap-2`}
                                >
                                    <div className=' font-semibold text-[13px] leading-[26px] px-6 py-[24px]'>LinkedIn</div>
                                    <div className='relative cursor-pointer'>
                                        <Image src={Vector} alt='open' />
                                    </div>
                                </Link>
                        ...
                        <div className='flex justify-center items-center w-full h-[73px] border-black border-[0.5px]'>
                            <div className=' font-semibold text-[10px] leading-[20px] px-auto py-[5px]'>HONESTLY, NO RIGHTS RESERVED YET</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='w-full h-full p-8 mt-[50px] hidden lg:block'>
                <div className='flex flex-row  items-center '>
                    <div className='h-[179px] w-full border-black border-[0.5px]'>
                        <div className='flex flex-row w-full'>
                            <Link href='https://docsend.com/view/r6rvyffhbfnsghjn' target='_blank' className='w-1/3 h-[73px] border-black border-[0.5px] hover:bg-white'>
                                <div className=' font-semibold text-[13px] leading-[26px] flex items-center px-8 h-full cursor-pointer'>Tell me more, I like to read long form</div>
                            </Link>
                            <div className='w-1/3 h-[73px] border-black border-[0.5px] hover:bg-white' onClick={handleDestopFaqThree}>
                        ...
                        <div className='flex flex-row w-full'>
                            ...
                            <div className='w-1/3 h-[73px] border-black border-[0.5px] hover:bg-white'>
                                <div className=' font-semibold text-[13px] leading-[26px] flex items-center px-8 h-full cursor-pointer' onClick={handleDestopFaqTwo}>
                                    Work with us?&nbsp;
                        ...
                        <div className='flex justify-center items-center w-full h-[33px] border-black border-[0.5px]'>
                            <div className=' font-semibold text-[10px] leading-[20px] px-8 cursor-default'>HONESTLY, NO RIGHTS RESERVED YET</div>
                        </div>
                    </div>
                </div>
            </div>
