        ...
        <div className="mt-[42px] mx-9 font-ppmori font-normal text-[13px] leading-[19.5px] tracking-wider ">
          ...
          <div className="mt-4">
            ...
            <div className="md:hidden">
              We match you with people who are the same skin tone, skin type,
              age, gender, hair type as you, and have tried a whole bunch of
              products to give you
            ...
            <div className="hidden md:block">
              <div>
                ...
                though they read reviews, and watched hours and hours of Youtube
                and Instagram reels before buying.
              </div>
              <div className="mt-4">
