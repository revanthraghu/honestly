        ...
        <div>
            ...
            <div>
                <div
                    ...
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isOneAnimated == 1 ? "animate-color opacity-100" : ""}
            ...
            <div>
                <div
                    ref={twoRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isTwoAnimated == 1 ? "animate-color opacity-100" : ""}
            ...
            <div>
                <div
                    ref={threeRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isThreeAnimated == 1 ? "animate-color opacity-100" : ""}
            ...
            <div>
                <div
                    ref={fourRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isFourAnimated == 1 ? "animate-color opacity-100" : ""}
            ...
            <div>
                <div
                    ref={fiveRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isFiveAnimated == 1 ? "animate-color opacity-100" : ""}
                                ${!isFiveCentered ? "opacity-30" : ""}
                                ${isFiveCentered && isFiveAnimated == 2 ? "bg-darkEffect opacity-100 w-[330px] text-[#122B2E]" : ""}
                                `}
                ...
                >
                    <div
                        className={`w-[8px] h-[8px] rotate-45 
                                    ${isFiveAnimated == 1 ? "animate-diamond" : ""}
                                    ${isFiveCentered && isFiveAnimated == 2 ? "bg-[#FFFFFF] opacity-100 " : ""}
                                    `}>
                    </div>
                    <span className="h-[36px] py-[12px] font-ppmori text-[11.5px] 
            ...
            <div>
                <div
                    ref={sixRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isSixAnimated == 1 ? "animate-color opacity-100" : ""}
                                ${!isSixCentered ? "opacity-30" : ""}
                                ${isSixCentered && isSixAnimated == 2 ? "bg-darkEffect opacity-100 w-[330px] text-[#122B2E]" : ""}
                                `}
                ...
                >
                    <div
                        className={`w-[8px] h-[8px] rotate-45 
                                    ${isSixAnimated == 1 ? "animate-diamond" : ""}
                                    ${isSixCentered && isSixAnimated == 2 ? "bg-[#FFFFFF] opacity-100 " : ""}
                                    `}>
                    </div>
                    <span className="h-[36px] py-[12px] font-ppmori text-[11.5px] 
            ...
            <div>
                <div
                    ref={sevenRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isSevenAnimated == 1 ? "animate-color opacity-100" : ""}
                                ${!isSevenCentered ? "opacity-30" : ""}
                                ${isSevenCentered && isSevenAnimated == 2 ? "bg-darkEffect opacity-100 w-[330px] text-[#122B2E]" : ""}
                                `}
                ...
                >
                    <div
                        className={`w-[8px] h-[8px] rotate-45 
                                    ${isSevenAnimated == 1 ? "animate-diamond" : ""}
                                    ${isSevenCentered && isSevenAnimated == 2 ? "bg-[#FFFFFF] opacity-100 " : ""}
                                    `}>
                    </div>
                    <span className="h-[36px] py-[12px] font-ppmori text-[11.5px] 
            ...
            <div>
                <div
                    ref={eightRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isEightAnimated == 1 ? "animate-color opacity-100" : ""}
                                ${!isEightCentered ? "opacity-30" : ""}
                                ${isEightCentered && isEightAnimated == 2 ? "bg-darkEffect opacity-100 w-[330px] text-[#122B2E]" : ""}
                                `}
                ...
                >
                    <div
                        className={`w-[8px] h-[8px] rotate-45 
                                    ${isEightAnimated == 1 ? "animate-diamond" : ""}
                                    ${isEightCentered && isEightAnimated == 2 ? "bg-[#FFFFFF] opacity-100 " : ""}
                                    `}>
                    </div>
                    <span className="h-[36px] py-[12px] font-ppmori text-[11.5px] 
            ...
            <div>
                <div
                    ref={nineRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isNineAnimated == 1 ? "animate-color opacity-100" : ""}
                                ${!isNineCentered ? "opacity-30" : ""}
                                ${isNineCentered && isNineAnimated == 2 ? "bg-darkEffect opacity-100 w-[330px] text-[#122B2E]" : ""}
                                `}
                ...
                >
                    <div
                        className={`w-[8px] h-[8px] rotate-45 
                                    ${isNineAnimated == 1 ? "animate-diamond" : ""}
                                    ${isNineCentered && isNineAnimated == 2 ? "bg-[#FFFFFF] opacity-100 " : ""}
                                    `}>
                    </div>
                    <span className="h-[36px] py-[12px] font-ppmori text-[11.5px] 
            ...
            <div>
                <div
                    ref={tenRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isTenAnimated == 1 ? "animate-color opacity-100" : ""}
                                ${!isTenCentered ? "opacity-30" : ""}
                                ${isTenCentered && isTenAnimated == 2 ? "bg-darkEffect opacity-100 w-[330px] text-[#122B2E]" : ""}
                                `}
                ...
                >
                    <div
                        className={`w-[8px] h-[8px] rotate-45 
                                    ${isTenAnimated == 1 ? "animate-diamond" : ""}
                                    ${isTenCentered && isTenAnimated == 2 ? "bg-[#FFFFFF] opacity-100 " : ""}
                                    `}>
                    </div>
                    <span className="h-[36px] py-[12px] font-ppmori text-[11.5px] 
            ...
            <div>
                <div
                    ref={elevenRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isElevenAnimated == 1 ? "animate-color opacity-100" : ""}
                                ${!isElevenCentered  ? "opacity-30" : ""}
                                ${isElevenCentered && isElevenAnimated == 2 ? "bg-darkEffect opacity-100 w-[330px] text-[#122B2E]" : ""}
                                `}
                ...
                >
                    <div
                        className={`w-[8px] h-[8px] rotate-45 
                                    ${isElevenAnimated == 1 ? "animate-diamond" : ""}
                                    ${isElevenCentered && isElevenAnimated == 2 ? "bg-[#FFFFFF] opacity-100 " : ""}
                                    `}>
                    </div>
                    <span className="h-[36px] py-[12px] font-ppmori text-[11.5px] 
            ...
            <div>
                <div
                    ref={twelveRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isTwelveAnimated == 1 ? "animate-color opacity-100" : ""}
                                ${!isTwelveCentered ? "opacity-30" : ""}
                                ${isTwelveCentered && isTwelveAnimated == 2 ? "bg-darkEffect opacity-100 w-[330px] text-[#122B2E]" : ""}
                                `}
                ...
                >
                    <div
                        className={`w-[8px] h-[8px] rotate-45 
                                    ${isTwelveAnimated == 1 ? "animate-diamond" : ""}
                                    ${isTwelveCentered && isTwelveAnimated == 2 ? "bg-[#FFFFFF] opacity-100 " : ""}
                                    `}>
                    </div>
                    <span className="h-[36px] py-[12px] font-ppmori text-[11.5px] 
            ...
            <div>
                <div
                    ref={thirteenRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isThirteenAnimated == 1 ? "animate-color opacity-100" : ""}
                                ${!isThirteenCentered ? "opacity-30" : ""}
                                ${isThirteenCentered && isThirteenAnimated == 2 ? "bg-darkEffect opacity-100 w-[330px] text-[#122B2E]" : ""}
                                `}
                ...
                >
                    <div
                        className={`w-[8px] h-[8px] rotate-45 
                                    ${isThirteenAnimated == 1 ? "animate-diamond" : ""}
                                    ${isThirteenCentered && isThirteenAnimated == 2 ? "bg-[#FFFFFF] opacity-100 " : ""}
                                    `}>
                    </div>
                    <span className="h-[36px] py-[12px] font-ppmori text-[11.5px] 
            ...
            <div>
                <div
                    ...
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-6 
                                ${isFourteenAnimated == 1 ? "animate-color opacity-100" : ""}
                                ${!isFourteenCentered ? "opacity-30" : ""}
                                ${isFourteenCentered && isFourteenAnimated == 2 ? "bg-darkEffect opacity-100 w-[330px] text-[#122B2E]" : ""}
                                `}
                ...
                >
                    <div
                        className={`w-[8px] h-[8px] rotate-45 
                                    ${isFourteenAnimated == 1 ? "animate-diamond" : ""}
                                    ${isFourteenCentered && isFourteenAnimated == 2 ? "bg-[#FFFFFF] opacity-100 " : ""}
                                    `}>
                    </div>
                    <span className="h-[36px] py-[12px] font-ppmori text-[11.5px]
            ...
            <div>
                <div
                    ref={fifteenRef}
                    className={`group flex flex-row justify-center items-center text-[#00A8FE] gap-8 
                                ${isFifteenAnimated == 1 ? "animate-color opacity-100" : ""}
                                ${!isFifteenCentered ? "opacity-30" : ""}
                                ${isFifteenCentered && isFifteenAnimated == 2 ? "bg-darkEffect opacity-100 w-[330px] text-[#122B2E]" : ""}
                                `}
                ...
                >
                    <div
                        className={`w-[8px] h-[8px] rotate-45 
                                    ${isFifteenAnimated == 1 ? "animate-diamond" : ""}
                                    ${isFifteenCentered && isFifteenAnimated == 2 ? "bg-[#FFFFFF] opacity-100 " : ""}
                                    `}>
                    </div>
                    <span className="h-[36px] py-[12px] font-ppmori text-[11.5px] 
