...
export default function ReviewSection() {
    const contents = [
        ...
        },
        {
            ...
            description: "Too many cooks spoil the broth (aka no more being overwhelmed with too many reccos)"
        }
    ];
                ...
                <div className='max-w-[386px] flex flex-col'>
                    ...
                    <div className='ml-[14px] text-[14px] leading-[18.2px] tracking-[4%]'>
                        ...
                        <div className='flex flex-col mt-[44px] '>
                            ...
                            <span>Too many cooks spoil the broth (aka no more being overwhelmed with too many reccos)</span>
                        </div>
                        <div className='flex flex-col mt-[44px]'>
            ...
            <div className='w-screen mt-8 min-[850px]:hidden'>
                <div className=' flex justify-center '>
                    <div className='flex flex-row gap-6 w-[320px]'>
                        ...
                        <div className='flex flex-col py-[13px] max-w-[172px] h-[128px] justify-center' ref={container}>
                            {contents.map((content, index) => (
                                ...
                                >
                                    <h2 className='font-semibold text-[13px] tracking-[4%] leading-[16.9px] whitespace-pre-wrap'>{content.title}</h2>
                                    <span className='font-normal text-[13px] tracking-[4%] leading-[16.9px] whitespace-pre-wrap'>{content.description}</span>
                                </div>
                            ))}
                        </div>
                    </div>
...
export function Collage() {
    return (
        <div className='grid grid-cols-5 h-[445px] min-w-[489px]'>
            <div className='flex justify-center items-center col-span-2 row-span-1 bg-[#E9E5DE] w-[171px] h-[100px]' style={hexagonStyle}>
                <Image src={review1} alt='review1' quality={100} unoptimized />
            </div>
            <div className='col-span-1 row-span-2 flex justify-center items-center bg-[#E9E5DE] -ml-[14px] p-[6px] w-[91px] h-[165px]' style={hexagonStyle}>
                <Image
                    src={reviewGif1}
                    alt='reviewGif1'
                    quality={100}
            ...
            <div className='col-span-1 row-span-2 flex justify-center items-center bg-[#E9E5DE] -ml-[10px] p-[6px] w-[99px] h-[165px]' style={hexagonStyle}>
                <Image
                    src={reviewGif2}
                    alt='reviewGif2'
                    quality={100}
            ...
            <div className='col-span-1 row-span-2 flex justify-center items-center bg-[#E9E5DE] ml-[2px] w-[100px] h-[166px]' style={hexagonStyle}>
                <Image
                    src={reviewGif3}
                    alt='reviewGif3'
                    quality={100}
            ...
            <div className='col-span-1 row-span-2 flex justify-center items-center bg-[#E9E5DE] mt-[6px] w-[94px] h-[166px]' style={hexagonStyle}>
                <Image
                    src={reviewGif4}
                    alt='reviewGif4'
                    quality={100}
            ...
            <div className='col-start-2 col-end-3 row-start-3 row-end-5 flex justify-center items-center bg-[#E9E5DE] -mt-[6px] ml-[14px] w-[91px] h-[154px]' style={hexagonStyle}>
                <Image
                    src={reviewGif5}
                    alt='reviewGif5'
                    quality={100}
            ...
            <div className='col-start-5 col-end-6 row-start-3 row-end-5 flex justify-center items-center bg-[#E9E5DE]  ml-1 w-[94px] h-[160px]' style={hexagonStyle}>
                <Image
                    src={reviewGif6}
                    alt='reviewGif6'
                    quality={100}
            ...
            <div className='col-span-1 row-span-2 flex justify-center items-center bg-[#E9E5DE] mt-[2px] w-[105px] h-[166px]' style={hexagonStyle}>
                <Image
                    src={reviewGif7}
                    alt='reviewGif7'
                    quality={100}
            ...
            <div className='col-span-2 row-span-1 flex justify-center items-center bg-[#E9E5DE] -mt-[72px] ml-[28px] w-[174px] h-[88px]' style={hexagonStyle}>
                <Image src={review3} alt='review3' quality={100} unoptimized />
            </div>

            <div className='col-span-2 row-span-1 flex justify-center items-center bg-[#E9E5DE] -mt-[60px] ml-6 w-[173px] h-[77px]' style={hexagonStyle}>
...
export function Slideshow() {
    ...
    return (
        <Carousel plugins={[plugin.current]} className='w-screen' onMouseEnter={plugin.current.stop} onMouseLeave={plugin.current.reset}>
            <CarouselContent className='-ml-1'>
                <CarouselItem>
                    <div className='flex justify-center mx-2 items-center bg-[#E9E5DE] min-w-[295px] min-h-[285px]' style={hexagonStyle}>
                        <Image
                            src={review2}
                            alt='review2'
                            quality={100}
                ...
                <CarouselItem>
                    <div className=' flex mx-2 justify-center items-center bg-[#E9E5DE] my-[6px] min-w-[184px] min-h-[328px]' style={hexagonStyle}>
                        <Image
                            src={reviewGif4}
                            alt='reviewGif4'
                            quality={100}
                ...
                <CarouselItem>
                    <div className='flex justify-center items-center  mx-2 bg-[#E9E5DE] min-w-[205px] min-h-[322px]' style={hexagonStyle}>
                        <Image
                            src={reviewGif7}
                            alt='reviewGif7'
                            quality={100}
                ...
                <CarouselItem>
                    <div className='flex justify-center items-center  mx-2 min-w-[178px] bg-[#E9E5DE] min-h-[301px]' style={hexagonStyle}>
                        <Image
                            src={reviewGif5}
                            alt='reviewGif5'
                            quality={100}
                ...
                <CarouselItem>
                    <div className='flex justify-center items-center  mx-2 bg-[#E9E5DE]  min-w-[185px] min-h-[318px]' style={hexagonStyle}>
                        <Image src={reviewGif6} alt='reviewGif6' quality={100} width={169} height={300} unoptimized />
                    </div>
                </CarouselItem>

                <CarouselItem>
                    <div className='flex justify-center items-center  mx-2 bg-[#E9E5DE] min-w-[178px] min-h-[325px]' style={hexagonStyle}>
                        <Image src={reviewGif1} alt='reviewGif1' quality={100} width={162} height={309} unoptimized />
                    </div>
                </CarouselItem>

                <CarouselItem>
                    <div className='flex justify-center items-center  mx-2 bg-[#E9E5DE] min-w-[193px] min-h-[330px]' style={hexagonStyle}>
                        <Image
                            src={reviewGif3}
                            alt='reviewGif3'
                            quality={100}
                ...
                <CarouselItem>
                    <div className='flex justify-center items-center  mx-2 bg-[#E9E5DE] min-w-[190px] min-h-[328px]' style={hexagonStyle}>
                        <Image src={reviewGif2} alt='reviewGif2' quality={100} width={174} height={309} unoptimized />
                    </div>
                </CarouselItem>
            </CarouselContent>
        </Carousel>
