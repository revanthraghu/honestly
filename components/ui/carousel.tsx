...
const CarouselItem = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => {
    ...
    return (
        <div
            ...
            className={cn("min-w-0 shrink-0 grow-0 flex items-center", orientation === "horizontal" ? "pl-4" : "pt-4", className)}
            {...props}
        />
    );
});
    ...
    return (
        <Button
            ...
            className={cn(
                ...
                orientation === "horizontal" ? "-left-9 sm:-left-12 top-1/2 -translate-y-1/2" : "-top-9 sm:-top-12 left-1/2 -translate-x-1/2 rotate-90",
                className
            )}
...
const CarouselNext = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
        <Button
            ...
            className={cn(
                "absolute overflow-hidden",
                orientation === "horizontal" ? "-right-9 sm:-right-12 top-1/2 -translate-y-1/2" : "-bottom-9 sm:-bottom-12 left-1/2 -translate-x-1/2 rotate-90",
                className
            )}
